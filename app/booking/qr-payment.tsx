    ...
    <View style={styles.container}>
      ...
      >
        ...
        <View style={styles.qrContainer}>
          ...
          <Text style={styles.qrHint}>Quét mã này bằng app ngân hàng của bạn</Text>
        </View>

        <View style={styles.bankInfoCard}>
          <View style={styles.bankInfoHeader}>
            <Text style={styles.bankInfoLogo}>{selectedBank.logo}</Text>
            <View style={styles.bankInfoTextContainer}>
              <Text style={styles.bankInfoName}>{selectedBank.name}</Text>
              <Text style={styles.bankInfoCode}>{selectedBank.bankCode}</Text>
            </View>
          </View>
          ...
          <View style={styles.infoSection}>
            <View style={styles.infoRow}>
              ...
              <View style={styles.infoValueContainer}>
                <Text style={styles.infoValue}>{selectedBank.accountNumber}</Text>
                <TouchableOpacity
            ...
            <View style={styles.infoRow}>
              ...
              <Text style={styles.infoValue}>{selectedBank.accountName}</Text>
            </View>
            ...
            <View style={styles.infoRow}>
              ...
              <View style={styles.infoValueContainer}>
                <Text style={styles.infoValue}>Thanh toan booking {bookingId}</Text>
                <TouchableOpacity
                  style={styles.copyButton}
      ...
      <View style={styles.bottomContainer}>
        <TouchableOpacity
          style={[styles.completeButton, isChecking && styles.completeButtonDisabled]}
          activeOpacity={0.8}
        ...
        >
          {isChecking ? (
            ...
            <Text style={styles.completeButtonText}>Kiểm tra thanh toán</Text>
          )}
        </TouchableOpacity>
        <TouchableOpacity
            ...
            <View style={styles.uploadSection}>
              {uploadedImage ? (
                ...
                >
                  ...
                  <Text style={styles.uploadButtonHint}>Chụp hoặc chọn ảnh xác nhận chuyển khoản</Text>
                </TouchableOpacity>
              )}
            </View>
