...
import { Search, ChevronLeft, Phone, Mail, Building2, User, Plus, Eye } from 'lucide-react-native';
    ...
    <View style={styles.container}>
      ...
      >
        ...
        <Text style={styles.resultCount}>
          Hiển thị <Text style={styles.resultCountBold}>{filteredCustomers.length}</Text> khách hàng
        </Text>
              ...
              <View style={styles.customerHeader}>
                <View style={styles.customerNameRow}>
                  <View style={[
                    ...
                    { backgroundColor: activeTab === 'personal' ? '#EFF6FF' : '#FDF2F8' }
                  ]}>
                    {activeTab === 'personal' ? (
              ...
              <View style={styles.customerInfo}>
                ...
                {customer.taxCode && (
                  <View style={styles.infoRow}>
                    ...
                    <Text style={styles.infoText}>MST: {customer.taxCode}</Text>
                  </View>
                )}
              </View>
